...
ICD_CODES = [
    ...
    ("I50.21", "Acute systolic (congestive) heart failure",
     ...
     "both", True,
     "2024-10-01", None,
     "Acute decompensation of systolic (reduced-EF) heart failure. High acuity; a primary indication for echocardiography and cardiac evaluation. Distinguish from diastolic (I50.3x) — requires documented reduced LVEF.",
     "CMS", "ICD-10-CM 2025", CMS_ICD_URL, "2025-01-01", 0.95, "CMS ICD-10-CM tabular", "mandatory"),
    ...
    ("I50.9", "Heart failure, unspecified",
     ...
     "both", True,
     "2024-10-01", None,
     "Unspecified heart failure. Code to higher specificity (systolic I50.2x / diastolic I50.3x) when documented. Supports cardiac imaging and evaluation.",
     "CMS", "ICD-10-CM 2025", CMS_ICD_URL, "2025-01-01", 0.90, "CMS ICD-10-CM tabular", "guideline"),
...
CPT_DX_COVERAGE = [
    ...
    ("93306", "R07.9", "supporting",
     ...
     "CMS", "LCD L33997 — Echocardiography", "https://www.cms.gov/medicare/coverage/lcds", "2025-01-01",
     0.80, "CMS MAC LCD supporting criteria", "guideline"),
    ("93306", "I50.21", "required",
     "Acute systolic (congestive) heart failure — echocardiography is standard of care to quantify LVEF and assess systolic function and wall motion during decompensation.",
     "CMS", "LCD L33997 — Echocardiography", "https://www.cms.gov/medicare/coverage/lcds", "2025-01-01",
     0.95, "CMS MAC LCD — heart-failure indication", "mandatory"),
    ("93306", "I50.9", "supporting",
     "Heart failure (unspecified) — echocardiography evaluates cardiac function and etiology; code to specificity when documented.",
     "CMS", "LCD L33997 — Echocardiography", "https://www.cms.gov/medicare/coverage/lcds", "2025-01-01",
    ...
    ("93000", "I50.21", "supporting",
     "Acute systolic heart failure — ECG assesses rhythm, ischemia, and conduction (e.g. LBBB) during decompensation; standard in the heart-failure workup.",
     "CMS", "LCD for ECG", "https://www.cms.gov/medicare/coverage/lcds", "2025-01-01",
     0.80, "CMS LCD — heart-failure indication", "guideline"),
